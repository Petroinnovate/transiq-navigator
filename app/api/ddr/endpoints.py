...
async def parse_ddr(
    ...
    from pipelines.inference.ddr.ddr_parser import parse_ddr_pdf
...
async def parse_ddr_batch(request: MultiParseRequest):
    ...
    from pipelines.inference.ddr.ddr_parser import parse_multiple_ddrs
...
async def detect_report(
    ...
    from pipelines.inference.ddr.report_detector import detect_report_type
...
async def fleet_spc_endpoint(request: FleetSPCRequest):
    ...
    from pipelines.inference.ddr.spc_engine import compute_fleet_spc
...
async def get_report_metrics(report_id: str):
    ...
    try:
        ...
        from pipelines.inference.ddr.citation_service import get_report_metrics as _get
...
async def get_metric_audit(metric_id: str):
    ...
    try:
        from services.db.session import get_db_session
        from pipelines.inference.ddr.citation_service import get_metric_audit_trail
...
async def update_metric_endpoint(metric_id: str, request: MetricUpdateRequest):
    ...
    try:
        from services.db.session import get_db_session
        from pipelines.inference.ddr.citation_service import update_metric
        from pipelines.inference.ddr.models import ExtractedMetric
