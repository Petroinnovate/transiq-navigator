...
if CELERY_AVAILABLE:
    ...
    def process_document(
        ...
        from app.utils.file_reader import read_file_content, get_file_chunks_for_dashboard
...
def _process_document_impl(
    ...
    try:
        from app.processors.pipeline import ChunkingPipeline
        from app.processors.deduction import DeductionEngine
        from app.processors.patterns import PatternRecognizer
        from app.storage.local import LocalStorage
