...
# ---------------------------------------------------------------------------
try:
    from pipelines.inference.context_builder import build_context
    from pipelines.inference.domain_glossary import DOMAIN_GLOSSARY
    from pipelines.inference.glossary_filter import build_term_index, filter_glossary, format_for_prompt
...
def run_pipeline(
    ...
    *,
    ...
    from pipelines.inference.validation import validate_kpis, validate_recommendations, validate_findings
