    ...
    >
        ...
        {sortedData.map((item, index) => (
          <Component
            ...
            className={cx(
              ...
              focusRing,
              onValueChange
                ? ["-m-0! cursor-pointer", "hover:bg-gray-50 dark:hover:bg-gray-900"]
                : "",
            )}
          >
            <div
            ...
            >
              <div className={cx("absolute left-2 flex max-w-full pr-2")}>
                {item.href ? (
                  ...
                  <p className={cx("truncate whitespace-nowrap text-sm", "text-gray-900 dark:text-gray-50")}>
                    {item.name}
                  </p>
                )}
              </div>
      ...
      <div>
        {sortedData.map((item, index) => (
          ...
          >
            <p className={cx("truncate whitespace-nowrap text-sm leading-none", "text-gray-900 dark:text-gray-50")}>
